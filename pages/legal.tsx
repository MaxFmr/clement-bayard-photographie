    ...
    <>
      ...
      <div style={{ margin: '10%' }}>
        <p>
          ...
          site internet {process.env.domain} sont :
        </p>
        ...
        Firefox, Google Chrome, etc… L’agence web Clément BAyard met en œuvre
        tous les moyens dont elle dispose, pour assurer une information fiable
        et une mise à jour fiable de ses sites internet. Toutefois, des erreurs
        ou omissions peuvent survenir. L’internaute devra donc s’assurer de
        l’exactitude des informations auprès de Clément Bayard , et signaler
        toutes modifications du site qu’il jugerait utile. Clément Bayard n’est
        ...
        Internet.Clément Bayard ne dispose d’aucun moyen pour contrôler les
        sites en connexion avec ses sites internet. Clément Bayard ne répond pas
        de la disponibilité de tels sites et sources externes, ni ne la
        garantit. Il ne peut être tenue pour responsable de tout dommage, de
        ...
        qui doit se conformer à leurs conditions d’utilisation. Les
        utilisateurs, les abonnés et les visiteurs des sites internet  ne
        peuvent pas mettre en place un hyperlien en direction de ce site sans
        l’autorisation expresse et préalable de Clément Bayard. Dans l’hypothèse
        ...
        courriel, à l’adresse bayard.clt@gmail.com, en décrivant le problème de
        ...
        <p>
          ...
          Clément Bayard. Cette représentation ou reproduction, par quelque
